...
public class ConfigBean {
    ...
    public void populateDB() {
        ...
        studentBean.create("2211028", "123", "João Guerra", "joao@mail.com", 2);
        studentBean.enrollStudentInSubject("2211027", 1001);
        studentBean.enrollStudentInSubject("2211028", 1001);
        administratorBean.create("admin", "123", "admin", "admin@mail.com");
        teacherBean.create("2211029", "123", "João Guerra", "joao_guerra@mail.com");


        // write on the log
        System.out.println("Database populated with a student with username up201806296 and password 123");
    }
}
